        ...
        >
          <div className="mb-7">
            <h2 className="text-white text-lg">
              Selamat Datang di <b>AKADEMIK.</b>
            </h2>
          ...
          <form onSubmit={handleSubmit(loginUser)}>
            <input
              ...
              className="w-full mb-4 px-5 py-3 bg-white/[0.04] border border-white/40 rounded-2xl text-white placeholder-white/60 outline-none focus:border-cyan-300 focus:bg-white/[0.06] transition"
            />
            ...
            <input
              ...
              className="w-full mb-7 px-5 py-3 bg-white/[0.04] border border-white/40 rounded-2xl text-white placeholder-white/60 outline-none focus:border-cyan-300 focus:bg-white/[0.06] transition"
            />
